...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { abv: @beer.abv, category: @beer.category, description: @beer.description, guid: @beer.guid, ibu: @beer.ibu, name: @beer.name, style: @beer.style }
    end
  ...
  test "should update beer" do
    put :update, id: @beer, beer: { abv: @beer.abv, category: @beer.category, description: @beer.description, guid: @beer.guid, ibu: @beer.ibu, name: @beer.name, style: @beer.style }
    assert_redirected_to beer_path(assigns(:beer))
  end
